...
<head>
    ...
    <div class="link-seperation">
        ...
        <ul class="ul-links">
            <li class="li-noticias">
                ...
                <a class="a-noticias IA" href="{{ url('/ia') }}">
                    IA
                </a>
    ...
    <div class="img-y-noticia">
        ...
        <div class="box-noticia">
            @foreach($publicaciones->where('categoria', 'IA')->reverse() as $publicacion)
    ...
    <img class="img-min-noticia" src="person.png" width="50" height="28">
        ...
        @foreach($publicaciones->where('categoria', 'IA')->slice(-2, -1)->reverse() as $publicacion)
    ...
    @foreach($publicaciones->where('categoria', 'IA')->slice(-3, -2)->reverse() as $publicacion)
    <div class="card-extra-noticias">
        <img class="img-min-noticia" src="person.png" width="50" height="28">
        <div class="box-min-noticia">
            <a class="a-min-noticia-section">{{ $publicacion->categoria }}</a>
    ...
    @endforeach
    @foreach($publicaciones->where('categoria', 'IA')->slice(-4, -3)->reverse() as $publicacion)
    <div class="card-extra-noticias">
        <img class="img-min-noticia" src="person.png" width="50" height="28">
        <div class="box-min-noticia">
            <a class="a-min-noticia-section">{{ $publicacion->categoria }}</a>
    ...
    @endforeach
    @foreach($publicaciones->where('categoria', 'IA')->slice(-5, -4)->reverse() as $publicacion)
    <div class="card-extra-noticias">
        <img class="img-min-noticia" src="person.png" width="50" height="28">
        <div class="box-min-noticia">
            <a class="a-min-noticia-section">{{ $publicacion->categoria }}</a>
    ...
    @endforeach
    @foreach($publicaciones->where('categoria', 'IA')->slice(-6, -5)->reverse() as $publicacion)
    <div class="card-extra-noticias">
        <img class="img-min-noticia" src="person.png" width="50" height="28">
        <div class="box-min-noticia">
            <a class="a-min-noticia-section">{{ $publicacion->categoria }}</a>
